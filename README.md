# EXP-1
EXPT NO: 1	VERIFICATION OF KIRCHHOFF’S LAWS<br>
AIM<br>
a.   To verify Kirchhoff’s Voltage Law (KVL) for the given circuit. <br>
b.   To verify Kirchhoff’s Current Law (KCL) for the given circuits.<br>
...
THEORY:<br>
KVL: Kirchhoff's voltage law states that the sum of the voltage differences around any closed loop in a circuit must be zero. A loop in a circuit is any path that ends at the same point at which it starts.<br>
KCL:<br>
...
<img width="1027" height="668" alt="Screenshot 2025-11-12 092033" src="https://github.com/user-attachments/assets/3a2c8ef5-61e4-48f0-8a3b-ec6c5efa37cb" />


b.  KCL:
 <img width="1284" height="548" alt="Screenshot 2025-11-12 094304" src="https://github.com/user-attachments/assets/03d547f1-36b9-49c1-8601-92d3cb0ced17" />
